...
/**
 * Lucide dropped brand/logo icons (Instagram, YouTube, etc.) from its set
 * since they're trademarked marks rather than generic UI icons. These are
 * small hand-drawn replacements using the same stroke-based style
 * (24x24 viewBox, currentColor stroke, round joins) so they blend in
 * visually with the rest of the lucide-react icons used across the app.
 *
 * Usage is a drop-in replacement for the old lucide imports:
